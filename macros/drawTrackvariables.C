...
TH2F* hPcorr = new TH1F("hPcorr", "#frac{p-p_{corr}}{p} vs p; p [Mev/c]; #Delta p/p; nTracks", 1000, 0, 2000, 100, 0, 1);
...
sprintf(picName, "./pics/PCorr.png");
canv->SaveAs(picName);
sprintf(picName, "./pics/PCorr.C");
canv->SaveAs(picName);
delete canv;
delete leg;
}
